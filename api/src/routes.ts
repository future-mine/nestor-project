...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/client',
            ...
            function ClientController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/client/:id',
            ...
            function ClientController_getClientById(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getClientById.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/client',
            ...
            function ClientController_create(request: any, response: any, next: any) {
            const args = {
                    dto: {"in":"body","name":"dto","required":true,"ref":"ClientModel"},
            };
        ...
        app.put('/client/:id',
            ...
            function ClientController_update(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    dto: {"in":"body","name":"dto","required":true,"ref":"ClientModel"},
            };
        ...
        app.delete('/client/:id',
            ...
            function ClientController_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
        ...
        app.get('/provider/:id',
            ...
            function ProviderController_getProviderById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.getProviderById.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/provider',
            ...
            function ProviderController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/provider',
            ...
            function ProviderController_create(request: any, response: any, next: any) {
            const args = {
                    dto: {"in":"body","name":"dto","required":true,"ref":"ProviderModel"},
            };
        ...
        app.put('/provider/:id',
            ...
            function ProviderController_update(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    dto: {"in":"body","name":"dto","required":true,"ref":"ProviderModel"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/provider/:id',

            function ProviderController_delete(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
